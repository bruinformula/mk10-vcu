...
const uint16_t APPS_1_ADC_MAX_VAL = 3124;
const uint16_t APPS_1_ADC_MIN_VAL = 970; //0 torque value 930

const uint16_t APPS_2_ADC_MAX_VAL = 2251;
const uint16_t APPS_2_ADC_MIN_VAL = 950; //0 torque value 900
